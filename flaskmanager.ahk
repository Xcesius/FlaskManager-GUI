...
Gui,Add,Checkbox,x210 y8 w95 h13 vFlask1box,Flask 1 Enabled
...
Gui,Add,Checkbox,x210 y32 w95 h13 vFlask2box,Flask 2 Enabled
...
Gui,Add,Checkbox,x210 y61 w95 h13 vFlask3box,Flask 3 Enabled
...
Gui,Add,Checkbox,x210 y91 w95 h13 vFlask4box,Flask 4 Enabled
...
Gui,Add,Checkbox,x210 y119 w95 h13 vFlask5box,Flask 5 Enabled
...
{
	global Flask1_timer
	if (A_TickCount - Flask1_timer > flask1duration) and GetKeyState(flasktrigger1, "P") {
...
{
	global Flask2_timer
	if (A_TickCount - Flask2_timer > flask2duration) and GetKeyState(flasktrigger2, "P") {
...
{
	global Flask3_timer
	if (A_TickCount - Flask3_timer > flask3duration) and GetKeyState(flasktrigger3, "P") {
...
{
	global Flask4_timer
	if (A_TickCount - Flask4_timer > flask4duration) and GetKeyState(flasktrigger4, "P") {
...
{
	global Flask5_timer
	if (A_TickCount - Flask5_timer > flask5duration) and GetKeyState(flasktrigger5, "P") {
